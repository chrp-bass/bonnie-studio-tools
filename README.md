...
| Tool | What it does |
|---|---|
| [**intake.html**](https://chrp-bass.github.io/bonnie-studio-tools/intake.html) | New-trip intake. Bonnie fills it in, taps **Generate Trip Brief**, and gets `brief.txt` + `gems.txt` to download or copy. Links straight to the shared Drive for photos. |
...
2. Downloads `brief.txt` + `gems.txt` → they go in `trips/<slug>/`
